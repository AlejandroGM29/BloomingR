      ...
      $("#fondo").toggle('scale', { percent: 0 }, 800, function () {
        ...
        $("#fondo2").toggle('scale', { percent: 0 }, 1000, async function () {
          ...
          setTimeout(async function () {
            ...
            await mostrarMensajeConDuracion("De verdad me gustas mucho, no tienes idea de cuánto. Me gusta tu estilo, tu figura, tu carita y tu forma de ser...", 16000);
            await mostrarMensajeConDuracion("Eres una mujer fuerte, que trata de dar siempre su mejor cara aunque no esté del todo bien.", 10000);
            await mostrarMensajeConDuracion("Supiste afrontar todo lo que la vida te puso, has sabido ir creciendo como persona aun estando sola", 12500);
            await mostrarMensajeConDuracion("Pero ya no tiene por qué ser así, niña. Sé que tú no ves una relación conmigo, al menos no aún, pero sé que me tienes tantita confianza y quiero que sepas que mientras yo esté aquí nunca más tendrás por qué sentirte sola", 23000);
            await mostrarMensajeConDuracion("De verdad quiero que siempre te sientas querida, cuidada, pero sobre todo que nunca te sientas sola", 13000);
            await mostrarMensajeConDuracion("Aquí voy a estar siempre para ti, porque como no me canso de decirte... TE QUIERO", 10000);
            await mostrarMensajeConDuracion("No sé qué tienes, no sé qué me hace sentir así, pero sé que tienes algo que hizo que te apreciara mucho", 12000);
            ...
            await mostrarMensajeConDuracion("Sí, estoy enamorado de ti, pero también sé que tienes problemas en tu casa, que hay cosas que ahora mismo no controlas y no tienes por qué sentirte presionada con esto", 15000);
            await mostrarMensajeConDuracion("No es algo que hago para meterte presión o lo que sea, simplemente quiero volvértelo a decir, las veces que sean necesarias", 12000);
            await mostrarMensajeConDuracion("Yo te quiero, te quiero demasiado, me haces muy feliz y espero yo también hacerte feliz a ti algún día...", 12000);
